...
const features = [
  {
    ...
    description: 'Nos protocoles de sécurité ont été développés avec les meilleurs physiciens quantiques pour garantir votre retour en toute sécurité.',
  },
  {
    title: 'Guides Experts',
    description: 'Chaque voyage est accompagné par un chrononaute certifié, expert de l\'époque visitée et formé aux situations d\'urgence temporelle.',
  },
  {
    title: 'Expériences Sur Mesure',
    description: 'Nous créons des itinéraires personnalisés selon vos centres d\'intérêt : art, science, aventure ou découverte culturelle.',
  },
]
    ...
    <section id="about" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <span className="text-primary text-sm tracking-widest uppercase mb-4 block">Notre Agence</span>
          <h2 className="text-4xl md:text-5xl font-serif text-foreground mb-6">
            Pionniers du Voyage Temporel
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg leading-relaxed">
            Depuis 2024, TimeTravel Agency repousse les limites du possible en offrant 
            des voyages sécurisés à travers les époques les plus fascinantes de l'histoire.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-3xl md:text-4xl font-serif text-foreground mb-2">{stat.value}</div>
