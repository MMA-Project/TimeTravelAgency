        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              Notre équipe de chrononautes vous contactera dans les 24 heures
              terrestres pour finaliser votre voyage temporel.
            </p>
            <Button
              variant="outline"
              onClick={() => {
        ...
        >
          <div className="bg-card border border-border rounded-2xl p-8 md:p-10">
            ...
            <p className="text-center text-muted-foreground text-sm mt-6">
              En soumettant ce formulaire, vous acceptez nos conditions de
              voyage temporel.
            </p>
          </div>
        </motion.form>
