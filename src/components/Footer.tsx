        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              La première agence de voyage temporel au monde. Explorez le passé
              en toute sécurité avec nos experts chrononautes.
            </p>
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground text-sm">
              © {currentYear} TimeTravel Agency. Tous droits réservés à travers
              le temps.
            </p>
            <div className="flex items-center gap-6">
              <span className="text-xs text-muted-foreground">
                Licence de voyage temporel N°42-CHRONO
              </span>
            </div>
          </div>
        </div>
